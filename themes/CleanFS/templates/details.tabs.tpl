...
?><li id="commentstab"><a href="#comments"><?php echo Filters::noXSS(L('comments')); ?> (<?php echo count($comments); ?>)</a></li><?php
endif;
?><li id="relatedtab"><a href="#related"><?php echo Filters::noXSS(L('relatedtasks')); ?> (<?php echo count($related); ?>/<?php echo count($duplicates); ?>)</a></li><?php
if ($user->perms('manage_project')): ?><li id="notifytab"><a href="#notify"><?php echo Filters::noXSS(L('notifications')); ?> (<?php echo count($notifications); ?>)</a></li><?php
if (!$task_details['is_closed']): ?><li id="remindtab"><a href="#remind"><?php echo Filters::noXSS(L('reminders')); ?> (<?php echo count($reminders); ?>)</a></li><?php
endif;
endif;
