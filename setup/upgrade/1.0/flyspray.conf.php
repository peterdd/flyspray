...
reminder_daemon = "0" ; Boolean. 0 = off, 1 = on (needs to setup crontab or similiar)
passwdcrypt = "" ; Available options: "" - chooses best default (currently "crypt"), "crypt", "md5", "sha1" Note: md5 and sha1 are considered insecure. Only use if required compatibility with legacy apps.
